      ...
      <div className="glass-card overflow-hidden">
        <div className="overflow-x-auto w-full">
          <div className="min-w-[500px]">
            {/* Column headers */}
            <div className="grid grid-cols-[72px_1fr_56px_80px_96px] gap-1 px-3 py-4 bg-muted/30 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
              <span>Ngày</span>
              <span>Ghi chú</span>
          ...
          {visibleEntries.map((e, idx) => {
            ...
            return (
              <div key={`${e.entry_date}-${e.sort_order}`}>
                <div
                  className={`grid grid-cols-[72px_1fr_56px_80px_96px] gap-1 px-3 py-4 items-center text-base ${
