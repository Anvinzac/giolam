...
-- This script ensures all dates in a period have entries for overtime and notice_only employees
    ...
    LOOP
      ...
      LOOP
        ...
        IF existing_count = 0 THEN
          ...
          RAISE NOTICE 'Added missing entry for user % on date %', profile_rec.user_id, date_rec.entry_date;
        END IF;
      END LOOP;
    END LOOP;
  END LOOP;
